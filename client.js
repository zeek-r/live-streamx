...
export function makeTrackControlEl(peerName, mediaTag, mediaInfo) {
...
export async function showCameraInfo() {
  let deviceId = await getCurrentDeviceId(),
    infoEl = $('#camera-info');
  if (!deviceId) {
    infoEl.innerHTML = '';
...
export function updateCamVideoProducerStatsDisplay() {
...
export function updateConsumersStatsDisplay() {
  try {
...
export function makeProducerTrackSelector({ internalTag, container, peerId, producerId,
